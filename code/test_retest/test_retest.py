...
match_test_params, match_retest_params = tr.load_parameters(subjects, 'match', parameter_choice, f'{results_dir}/hcp_testretest/short_iterations',test_idx=0)
...
mean_test_params, mean_retest_params = tr.load_parameters(subjects, 'mean', parameter_choice, f'{results_dir}/hcp_testretest/short_iterations')
