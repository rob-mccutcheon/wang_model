...
results_dir = f'/users/k1201869/wang_model/results/hcp_testretest/single_params/{dataset}'
...
init_version = 0
try:
    init_version = int(max(os.listdir(f'/users/k1201869/wang_model/temp/hcp_testretest/single_params/{dataset}/{subject}')))
    saved_variables_filename = os.listdir(f'/users/k1201869/wang_model/temp/hcp_testretest/single_params/{dataset}/{subject}/{init_version}')[0]
    saved_variables = pickle.load(open(f'/users/k1201869/wang_model/temp/hcp_testretest/single_params/{dataset}/{subject}/{init_version}/{saved_variables_filename}', 'rb'))
...
for version in range(init_version, 6):
    ...
    #    JK = JFK[:, p:]
        ...
        temp_directory = f'/users/k1201869/wang_model/temp/hcp_testretest/single_params/{dataset}/{subject}/{version}'
